%% ========================================================================
%  BEHAVIOR-SPECIFIC SPIKE-PHASE COUPLING ANALYSIS
...
%  2. Calculates spike-phase coupling for each unit × frequency band × behavior
...
fprintf('=== BEHAVIOR-SPECIFIC SPIKE-PHASE COUPLING ANALYSIS ===\n\n');
...
for spike_sess_idx = 1:num_aversive_sessions
    ...
    save_filename = fullfile(RewardAversivePath, sprintf('%s_spike_phase_coupling_by_behavior.mat', base_filename));
...
for spike_sess_idx = 1:num_reward_sessions
    ...
    %% Save results
    [~, base_filename, ~] = fileparts(spike_filename);
    save_filename = fullfile(RewardSeekingPath, sprintf('%s_spike_phase_coupling_by_behavior.mat', base_filename));
    save(save_filename, 'session_results', 'config', '-v7.3');
...
fprintf('\nNext step: Run Visualize_Spike_Phase_Coupling_BehaviorSpecific.m\n');
fprintf('========================================\n');
