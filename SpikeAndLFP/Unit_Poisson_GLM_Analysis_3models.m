%% ========================================================================
%  POISSON GLM ANALYSIS: 3 Nested Model Comparison
%  ========================================================================
%
%  Fits 3 nested Poisson GLMs to test incremental contributions:
%    Model 1: Bias + Spike History + Events + Coordinates + Spatial (baseline - "all other")
%    Model 2: Model 1 + Speed
%    Model 3: Model 2 + Breathing
%
%  This uses the SAME predictors as the 5-model analysis, but focuses on
%  testing whether speed and breathing add explanatory power beyond the
%  baseline model that includes intrinsic dynamics, task events, and
%  spatial encoding.
%
%  Output: Unit_GLM_Nested_Results_3models.mat
%% ========================================================================

clear all
close all

fprintf('\n=== POISSON GLM: 3 NESTED MODEL ANALYSIS ===\n\n');
...
% Output
config.output_file = 'Unit_GLM_Nested_Results_3models.mat';
...
% Find all sessions
session_types = {'Aversive'};
session_patterns = {'2025*RewardAversive*.mat'};
...
for session_type_idx = 1:length(session_types)
    ...
    for sess_idx = 1:n_sessions
        ...
        % Build design matrices (same as 5-model analysis)
        ...
        fprintf('    Model 1: %d predictors (bias + spike history + events + coords + spatial)\n', 1 + config.history_lags + size(DM2, 2));
        ...
        for unit_idx = 1:n_units
            ...
            %   Model 1 = Events + Coords + Spatial (DM2)
            ...
            try
                ...
                % Model 1: Bias + Spike History + Events + Coords + Spatial (baseline)
...
if ~isempty(all_results)
    ...
    fprintf('  Model 1 (All other):          %.2f ± %.2f%%\n', mean(dev_exp_1), std(dev_exp_1));
...
%% ========================================================================
%  HELPER FUNCTIONS (copied exactly from Unit_Poisson_GLM_Analysis.m)
%% ========================================================================
